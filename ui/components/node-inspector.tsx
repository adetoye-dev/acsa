  ...
  return (
    <aside className="panel-surface flex flex-col overflow-hidden">
      ...
      <div className="space-y-5 overflow-y-auto px-5 py-5">
        ...
        {inspectorError ? (
          <div className="rounded-2xl border border-ember/20 bg-ember/5 px-4 py-3 text-sm leading-6 text-ember">
            {inspectorError}
          </div>
        ) : null}

        <div className="ui-panel-card p-4 text-sm leading-6 text-slate">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate/65">
            Secret policy
          </div>
          <p className="mt-3">
